...
export default function Hero2() {
  ...
  return (
    <div
      style={{ backgroundImage: 'url("/img/bg5.webp")' }}
      className= {"bg-cover pt-20 md:pt-20 h-screen bg-no-repeat bg-center sticky top-0 flex flex-col items-center justify-center transition-opacity duration-200 " + (scrollPosition < 100 ? " opacity-100" : scrollPosition < 200 ? " opacity-75" : scrollPosition < 300 ? " opacity-50" : scrollPosition < 400 ? " opacity-25" : " opacity-0" )}
    >
      <Container className="flex flex-wrap text-center">
          ...
          <div className="hidden lg:block">
            ...
            /> */}
              {/* <Image
                ...
                loading="eager" 
              /> */}
            {/* <div className=" overflow-hidden w-[350px] h-[350px] rounded-full bg-white">
            </div> */}
          </div>
        </div>
      </Container>
