...
import heroSide1 from "../public/img/heroSide1.webp";
import heroSide2 from "../public/img/heroSide2.webp";

export default function Hero() {
  return (
    <div style={{ backgroundImage : 'url("/img/bg6.webp")', backgroundPositionX: '5rem', backgroundPositionY: '-5rem',}} className=" bg-cover   pt-20 md:pt-44 h-screen bg-no-repeat ">
      <Container className="flex flex-wrap">
          ...
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-x-3 space-y-3 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-gradient-to-br from-[#FF4BCE] to-[#860EFF] rounded-md ">
                Download for Free
              </a>
              <a
                href="http://"
        ...
        <div className="flex justify-center w-full lg:w-1/2">
          <div className="hidden w-[350px] h-[350px] relative bg-white shadow-xl rounded-full lg:block">
            <div className=" w-32 h-32 bg-gradient-to-br absolute z-10 -top-12 from-[#FF4BCE] to-[#860EFF] rounded-full">
            </div>
            <div className="hidden md:w-full md:h-full overflow-hidden bg-white md:flex md:items-center md:justify-center shadow-xl rounded-full">
            <img src='/img/heroSide1.webp' className=" object-cover object-right w-full h-full " alt="" />
            {/* <img src='/img/heroSide2.webp' className=" object-cover object-right w-full h-full " alt="" /> */}
            </div>
            {/* <Image
              src={heroSide2}
              width="616"
